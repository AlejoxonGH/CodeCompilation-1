...
namespace FSM
{
	public class RvB_State<T>
    {
		...
		public RvB_State(string name)
        {
			_stateName = name;
		}

		public RvB_State<T> Configure(Dictionary<T, Transition<T>> transitions)
        {
		...
		public bool CheckInput(T input, out RvB_State<T> next)
        {
